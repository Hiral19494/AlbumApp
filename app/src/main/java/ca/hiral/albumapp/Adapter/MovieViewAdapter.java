...
//            ll.addView(i1);
    ...
    public MovieViewAdapter(List<Moviemodel> moviesList, Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.title.setText(movie.getShow_title());
//
//        URL newurl = null;
//        try {
...
//       Picasso.with(context).load(moviesList.get(position).getPoster()).placeholder(R.mipmap.ic_launcher).into(holder.imagename);
